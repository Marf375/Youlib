...
class Books extends React.Component {
  ...
  getComicsBooks = () => {
    ...
    return filteredBooks.filter(book => book.type === "books");
  };
      ...
      <div className="container mx-auto p-6">
        ...
        {showFilters && (
          <div className="mb-6 p-4 bg-gray-100 rounded-lg">
            <h1 className="text-xl font-bold mb-3 text-white">Жанры</h1>
            <form>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4 text-[white]">
                {genres.map(genre => (
        ...
        <h2 className="text-2xl font-bold mb-4 text-white">Книги</h2>
